        ...
        <div className="bg-white rounded-xl shadow-sm border border-[#2F4C3B]/10 p-4 sm:p-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="min-w-0">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-[#2F4C3B]">
                My Orders
              </h2>
            ...
            <button
              ...
              className="w-full sm:w-fit px-5 py-3 bg-[#E24A3B] hover:bg-[#c73f31] active:bg-[#c73f31] text-white rounded-lg text-sm sm:text-base font-medium transition shrink-0"
            >
              View All Orders →
            </button>
